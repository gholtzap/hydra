...
contextBridge.exposeInMainWorld("claudeWorkspace", {
    ...
    getGitHubNativeAuthStatus: () => invoke<GitHubNativeAuthStatus>("github:nativeAuthStatus"),
    startGitHubDeviceAuth: () => invoke<GitHubDeviceAuthStartResult>("github:startDeviceAuth"),
    pollGitHubDeviceAuth: () => invoke<GitHubDeviceAuthPollResult>("github:pollDeviceAuth"),
    disconnectGitHubNativeAuth: () => invoke<GitHubNativeAuthStatus>("github:disconnectNativeAuth"),
